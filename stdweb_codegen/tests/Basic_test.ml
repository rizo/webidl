...
let () = Jx.log "Basic"
let test_2 = Types1.f6 ~cb:(fun _null_int _bool -> "hello") ()
...
let test_3 this =
  ...
  let _ =
    Node_list.filter_by_func_nullable
      ...
      this
  in
  let _ = Node_list.filter_by_name ~name:"div" this in
...
let test_9 this = Node_list.filter_by_name ~name:"div" this
